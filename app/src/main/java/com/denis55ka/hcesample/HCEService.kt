...
const val SELECT_COMMAND = "00 A4 04 00 08 F7 4C 69 63 61 72 64 01 00"
...
const val COMPUTE_CRYPTOGRAPHIC_CHECKSUM_COMMAND = "80 2A 8E 80"
...
class HCEService : HostApduService() {
    ...
    override fun processCommandApdu(commandApdu: ByteArray, extras: Bundle?): ByteArray? {
        ...
        val response = when {
            ...
            commandApdu.toHexString().startsWith(COMPUTE_CRYPTOGRAPHIC_CHECKSUM_COMMAND) -> COMPUTE_CRYPTOGRAPHIC_CHECKSUM_RESPONSE.toByteArray()
            else -> null
        }
